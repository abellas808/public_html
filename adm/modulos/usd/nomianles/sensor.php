...
// Consulta
// ***************************************************************************************************
$listado = $db->query('SELECT SQL_CALC_FOUND_ROWS * FROM variables_usd WHERE tipo = 11'. $sql_b . ' order by ' . $sql_o . ' ' . $sql_od . ';');
...
<div class="row">
    ...
    <h4 style="margin: 20px">Sensor de Estacionamiento</h4>
    <hr>
        ...
        <tbody>
            ...
            ?>
                <tr>
                        ...
                        <td>
                            <?php echo_s($entrada['sensor_estacionamiento']); ?>
                        </td>
                        <td>
