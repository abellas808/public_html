...
// Consulta
// ***************************************************************************************************
$listado = $db->query('SELECT SQL_CALC_FOUND_ROWS * FROM variables_usd WHERE tipo = 3'. $sql_b . ' order by ' . $sql_o . ' ' . $sql_od . ';');
...
<div class="row">
    ...
    <h4 style="margin: 20px">Correa de Distribución</h4>
    <hr>
