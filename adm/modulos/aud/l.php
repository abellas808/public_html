...
// Consulta
// ***************************************************************************************************
$listado = $db->query('SELECT SQL_CALC_FOUND_ROWS * FROM variables' . $sql_b . ' order by ' . $sql_o . ' ' . $sql_od . ' limit ' . (($pagina - 1) * $config['pagina_cant']) . ', ' . $config['pagina_cant'] . ';');
...
?>
	...
	<form id="form_listado" action="?m=<?php echo $modulo['prefijo'] . '_e'; ?>" method="post">
		<?php require_once("modulos/aud/porcentaje/fichas.php"); ?>
		<?php require_once("modulos/aud/porcentaje/cantidad_duenios.php"); ?>
		<?php require_once("modulos/aud/porcentaje/venta.php"); ?>
		<?php require_once("modulos/aud/porcentaje/stock.php"); ?>
		<?php require_once("modulos/aud/porcentaje/color.php"); ?>
		<?php require_once("modulos/aud/porcentaje/choque_leve.php"); ?>
		<?php require_once("modulos/aud/porcentaje/choque_grave.php"); ?>
		<?php require_once("modulos/aud/porcentaje/tapizado.php"); ?>
		<?php require_once("modulos/aud/porcentaje/volante.php"); ?>
	</form>
	<script>
