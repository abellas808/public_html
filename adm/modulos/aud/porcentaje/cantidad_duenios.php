...
// Consulta
// ***************************************************************************************************
$listado = $db->query('SELECT SQL_CALC_FOUND_ROWS * FROM variables WHERE tipo = 4'. $sql_b . ' order by ' . $sql_o . ' ' . $sql_od . ';');
...
<div class="row">
    ...
    <h4 style="margin: 20px">Cantidad de Dueños</h4>
    <hr>
        ...
        <tbody>
            ...
            ?>
                <tr>
                        ...
                        <td>
                            <?php echo_s($entrada['cantidad_duenios']); ?>
                        </td>
                        <td>
