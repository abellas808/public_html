...
// Consulta
// ***************************************************************************************************
$listado = $db->query('SELECT SQL_CALC_FOUND_ROWS * FROM variables WHERE tipo = 3'. $sql_b . ' order by ' . $sql_o . ' ' . $sql_od . ';');
        ...
        <tbody>
            ...
            ?>
                <tr>
                        ...
                        <td>
                            <?php echo_s($entrada['ficha_oficial']); ?>
                        </td>
                        <td>
